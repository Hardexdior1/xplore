...
<select name="activeType" id="activeType" className="text-xs bg-white cursor-pointer sm:text-base" defaultValue="">
...
<select name="season" id="season" className="text-xs bg-white cursor-pointer sm:text-base" defaultValue="">
...
<select name="groupSize" id="groupSize" className="text-xs bg-white cursor-pointer sm:text-base" defaultValue="">
